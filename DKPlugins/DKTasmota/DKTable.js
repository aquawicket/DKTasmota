//////////////////////////////////////////////////////////
DKCreateTable = function(parent, top, left, width, height)
{
...
DKTableAddRow = function(table)
{
    ...
    return table.rows.length; //return the created row number
}
...
DKTableAddColumn = function(table)
{
    ...
    return table.rows[0].cells.length; //return the created column number
}
