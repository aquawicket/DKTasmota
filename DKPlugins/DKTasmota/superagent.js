!function(t) {
    ...
    e.prototype.emit = function(t) {
        ...
        for (var e = new Array(arguments.length - 1), r = this._callbacks["$" + t], o = 1; o < arguments.length; o++)
            e[o - 1] = arguments[o];
        if (r) {
            o = 0;
            for (var n = (r = r.slice(0)).length; o < n; ++o)
                r[o].apply(this, e)
        }
        return this
    }
    ...
    function s(t, e, r) {
            ...
            if ("object" == o(e) && null !== e) {
                for (u = 0; u < s.length; u++)
                    if (s[u] === e) {
                        ...
                        n.push([a, r, e, c])) : i.push([e, r]) : (a[r] = "[Circular]",
                        n.push([a, r, e])))
                    }
                if (s.push(e),
                Array.isArray(e))
        ...
        s = 0 === i.length ? JSON.stringify(t, e, r) : JSON.stringify(t, c(e), r); 0 !== n.length; ) {
            var a = n.pop();
            ...
            if ("object" == o(e) && null !== e) {
                for (c = 0; c < s.length; c++)
                    if (s[c] === e) {
                        ...
                        n.push([u, r, e, l])) : i.push([e, r]) : (u[r] = "[Circular]",
                        n.push([u, r, e])))
                    }
      ...
      , y = {
        ...
        encode: function(t, e, r) {
            if (0 === t.length)
                return t;
            var o = t;
            if ("symbol" == l(t) ? o = Symbol.prototype.toString.call(t) : "string" != typeof t && (o = String(t)),
            "iso-8859-1" === r)
            ...
            for (var n = "", i = 0; i < o.length; ++i) {
                ...
                45 === s || 46 === s || 95 === s || 126 === s || s >= 48 && s <= 57 || s >= 65 && s <= 90 || s >= 97 && s <= 122 ? n += o.charAt(i) : s < 128 ? n += h[s] : s < 2048 ? n += h[192 | s >> 6] + h[128 | 63 & s] : s < 55296 || s >= 57344 ? n += h[224 | s >> 12] + h[128 | s >> 6 & 63] + h[128 | 63 & s] : (i += 1,
                s = 65536 + ((1023 & s) << 10 | 1023 & o.charCodeAt(i)),
                n += h[240 | s >> 18] + h[128 | s >> 12 & 63] + h[128 | s >> 6 & 63] + h[128 | 63 & s])
            }
            return n
        },
        isBuffer: function(t) {
        ...
        merge: function t(e, r, o) {
            ...
            f(e) && f(r) ? (r.forEach((function(r, n) {
                if (p.call(e, n)) {
                    var i = e[n];
            ...
            e) : Object.keys(r).reduce((function(e, n) {
                var i = r[n];
                return p.call(e, n) ? e[n] = t(e[n], i, o) : e[n] = i,
                e
            }
            ), n)
        }
    ...
    var w = Object.prototype.hasOwnProperty
      ...
      , k = function t(e, r, o, n, i, s, a, u, c, l, p, f, h) {
        ...
        null === m) {
            if (n)
                return s && !f ? s(r, x.encoder, h, "key") : r;
            m = ""
        }
        if ("string" == typeof (d = m) || "number" == typeof d || "boolean" == typeof d || "symbol" == _(d) || "bigint" == typeof d || y.isBuffer(m))
            return s ? [p(f ? r : s(r, x.encoder, h, "key")) + "=" + p(s(m, x.encoder, h, "value"))] : [p(r) + "=" + p(String(m))];
        var b, v = [];
        if (void 0 === m)
            return v;
        if (T(a))
    ...
    Array.isArray,
    {
        stringify: function(t, e) {
            ...
            "function" == typeof n.filter ? o = (0,
            n.filter)("", o) : T(n.filter) && (r = n.filter);
            var i, s = [];
            ...
            return n.charsetSentinel && ("iso-8859-1" === n.charset ? p += "utf8=%26%2310003%3B&" : p += "utf8=%E2%9C%93&"),
            l.length > 0 ? p + l : ""
        }
    });
    function C(t) {
        ...
        if (t)
            return function(t) {
                for (var e in q.prototype)
                    Object.prototype.hasOwnProperty.call(q.prototype, e) && (t[e] = q.prototype[e]);
                return t
            }(t)
    }
    P = q,
    ...
    q.prototype._shouldRetry = function(t, e) {
        ...
        if (e && e.status && H.has(e.status))
            return !0;
        if (t) {
            if (t.code && N.has(t.code))
                return !0;
    ...
    q.prototype.send = function(t) {
        ...
        if (e && R(this._data))
            ...
            this._data = "application/x-www-form-urlencoded" === r ? this._data ? "".concat(this._data, "&").concat(t) : t : (this._data || "") + t) : this._data = t;
        return !e || this._isHost(t) || r || this.type("json"),
        this
    }
    ,
        ...
        if (t)
            return function(t) {
                for (var e in M.prototype)
                    Object.prototype.hasOwnProperty.call(M.prototype, e) && (t[e] = M.prototype[e]);
                return t
            }(t)
    }
    z = M,
    ...
    function V() {}
    "undefined" != typeof window ? $ = window : "undefined" == typeof self ? (console.warn("Using browser-only version of superagent in non-browser environment"),
    $ = void 0) : $ = self;
    ...
    J.Request = ot,
    K.getXHR = function() {
        if ($.XMLHttpRequest && (!$.location || "file:" !== $.location.protocol || !$.ActiveXObject))
        ...
        if (void 0 !== r)
            if (null !== r)
                if (Array.isArray(r))
                    ...
                    for (var o in r)
                        Object.prototype.hasOwnProperty.call(r, o) && Z(t, "".concat(e, "[").concat(o, "]"), r[o]);
                else
                    t.push(encodeURI(e) + "=" + encodeURIComponent(r));
            else
                t.push(encodeURI(e))
    }
    function tt(t) {
        for (var e, r, o = {}, n = t.split("&"), i = 0, s = n.length; i < s; ++i)
            -1 === (r = (e = n[i]).indexOf("=")) ? o[decodeURIComponent(e)] = "" : o[decodeURIComponent(e.slice(0, r))] = decodeURIComponent(e.slice(r + 1));
        return o
    }
    function et(t) {
    ...
    function rt(t) {
        ...
        this.headers = function(t) {
            for (var e, r, o, n, i = t.split(/\r?\n/), s = {}, a = 0, u = i.length; a < u; ++a)
                -1 !== (e = (r = i[a]).indexOf(":")) && (o = r.slice(0, e).toLowerCase(),
                n = W(r.slice(e + 1)),
                s[o] = n);
            return s
    ...
    function ot(t, e) {
        ...
        this.on("end", (function() {
            ...
            t.response = o,
            t.status = o.status,
            r.callback(t, o)) : r.callback(null, o)
        }
        ))
    }
    function nt(t, e, r) {
    ...
    rt.prototype._parseBody = function(t) {
        ...
        return this.req._parser ? this.req._parser(this, t) : (!e && et(this.type) && (e = K.parse["application/json"]),
    ...
    ot.prototype.type = function(t) {
        return this.set("Content-Type", K.types[t] || t),
        this
    }
    ,
    ot.prototype.accept = function(t) {
        return this.set("Accept", K.types[t] || t),
        this
    }
    ,
    ot.prototype.auth = function(t, e, r) {
        return 1 === arguments.length && (e = ""),
        "object" == G(e) && null !== e && (r = e,
        e = ""),
        r || (r = {
    ...
    ot.prototype._getFormData = function() {
        return this._formData || (this._formData = new $.FormData),
        this._formData
    }
    ,
    ...
    ot.prototype._end = function() {
        ...
        if (this.hasListeners("progress"))
            try {
                ...
                e.upload && e.upload.addEventListener("progress", o.bind(null, "upload"))
            } catch (a) {}
        ...
        !this._formData && "GET" !== this.method && "HEAD" !== this.method && "string" != typeof r && !this._isHost(r)) {
            ...
            !i && et(n) && (i = K.serialize["application/json"]),
            i && (r = i(r))
        }
